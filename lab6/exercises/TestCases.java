...
public class TestCases
{
   ...
   private LongSupplier getNumberGenerator()
   {
      ...
      return () -> number[0]++; //keeps adding 1 more
   }
   ...
   public void testExercise3()
   {
      ...
      final LongUnaryOperator add7 = curried.apply(7); //add with
      final LongUnaryOperator add3 = curried.apply(3); //add with
   ...
   public void testExercise6()
   {
      ...
      final List<Integer> result = filterIt(numbers, x -> (x & 1) == 0); //bitshifting only even nums
