...
//   public Set<AnimationEntity> animationEntities;
   ...
   public static final int SPONGEBOB_NUM_PROPERTIES = 7;
   public static final int SPONGEBOB_ID = 1;
   public static final int SPONGEBOB_COL = 2;
   public static final int SPONGEBOB_ROW = 3;
   public static final int SPONGEBOB_LIMIT = 4;
   public static final int SPONGEBOB_ACTION_PERIOD = 5;
   public static final int SPONGEBOB_ANIMATION_PERIOD = 6;

   public static final String PATRICK_KEY = "patrick";
   public static final String PATRICK_ID_PREFIX = "patrick -- ";
   public static final int PATRICK_NUM_PROPERTIES = 7;
   public static final int PATRICK_ID = 1;
   public static final int PATRICK_COL = 2;
   public static final int PATRICK_ROW = 3;
   public static final int PATRICK_LIMIT = 4;
   public static final int PATRICK_ACTION_PERIOD = 5;
   public static final int PATRICK_ANIMATION_PERIOD = 6;
...
//      this.animationEntities = new HashSet<>();
   ...
   */
   ...
   public Entitys createPatrick(String id, Point position, int actionPeriod, int animationPeriod, List<PImage> images){
      return (Entitys)(new Patrick(id, position, images, actionPeriod, animationPeriod, path));
   }

   public Entitys createSpongebob(String id,  Point position, int actionPeriod, int animationPeriod, List<PImage> images){
      return (Entitys)(new Spongebob( id, position, images,  actionPeriod, animationPeriod, path));
   }
   ...
   public boolean parseSpongebob(String [] properties,
                             ImageStore imageStore)
   {
      if (properties.length == SPONGEBOB_NUM_PROPERTIES)
      {
         Point pt = new Point(Integer.parseInt(properties[SPONGEBOB_COL]),
                 Integer.parseInt(properties[SPONGEBOB_ROW]));
         Entitys entity = this.createSpongebob(properties[SPONGEBOB_ID],
                 pt,
                 Integer.parseInt(properties[SPONGEBOB_ACTION_PERIOD]),
                 Integer.parseInt(properties[SPONGEBOB_ANIMATION_PERIOD]),
                 imageStore.getImageList(SPONGEBOB_KEY));
         this.tryAddEntity( entity);
      }
      return properties.length == SPONGEBOB_NUM_PROPERTIES;
   }

   public boolean parsePatrick(String [] properties,
                              ImageStore imageStore)
   {
      if (properties.length == PATRICK_NUM_PROPERTIES)
      {
         Point pt = new Point(Integer.parseInt(properties[PATRICK_COL]),
                 Integer.parseInt(properties[PATRICK_ROW]));
         Entitys entity = this.createSpongebob(properties[PATRICK_ID], //CHECK
                 pt,
                 Integer.parseInt(properties[PATRICK_ACTION_PERIOD]),
                 Integer.parseInt(properties[PATRICK_ANIMATION_PERIOD]),
                 imageStore.getImageList(PATRICK_KEY));
         this.tryAddEntity( entity);
      }
      return properties.length == PATRICK_NUM_PROPERTIES;
   }
                              ...
                              ImageStore imageStore)
   {
      ...
      if (properties.length > 0)
      {
         switch (properties[PROPERTY_KEY])
         {
            ...
            case PATRICK_KEY:
               return this.parsePatrick(properties, imageStore);
            case SPONGEBOB_KEY:
               return this.parseSpongebob(properties, imageStore);
         }
      }
