...
//   public static final String CRAB_KEY = "crab"; //this blob
//   public static final String CRAB_ID_SUFFIX = " -- crab"; //this
//   public static final int CRAB_PERIOD_SCALE = 4; //this
//   public static final int CRAB_ANIMATION_MIN = 50; //this
//   public static final int CRAB_ANIMATION_MAX = 150; //this

   //public static final String QUAKE_KEY = "quake"; //this
//   public static final String QUAKE_ID = "quake";
//   public static final int QUAKE_ACTION_PERIOD = 1100;
//   public static final int QUAKE_ANIMATION_PERIOD = 100;
   //public static final int QUAKE_ANIMATION_REPEAT_COUNT = 10; //this


//   public static final String FISH_ID_PREFIX = "fish -- "; //this (ore)
//   public static final int FISH_CORRUPT_MIN = 20000; //this
//   public static final int FISH_CORRUPT_MAX = 30000; //this
//   public static final int FISH_REACH = 1; //maybe this FISH_KEY
...
//   public static Optional<Entity> nearestEntity(List<Entity> entities, //^^don't need
//      Point pos)
//   {
//      if (entities.isEmpty())
//      {
